  ...
  const projects = [
    {
      ...
      title: 'Sabor Caseiro',
      images: [
        '/landingpage/models/page1sc.jpg',
        '/landingpage/models/page2sc.jpg',
        '/landingpage/models/page3sc.jpg',
        '/landingpage/models/page4sc.jpg',
      ],
    },
    {
      id: 2,
      title: 'Barber Shop',
      images: [
        '/landingpage/models/page1bs.jpg',
        '/landingpage/models/page2bs.jpg',
        '/landingpage/models/page3bs.jpg',
        '/landingpage/models/page4bs.jpg',
        '/landingpage/models/page5bs.jpg',
        '/landingpage/models/page6bs.jpg',
      ],
    },
  ];
